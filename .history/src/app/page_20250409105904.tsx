...
import PressOnCatalog from "@/components/PressOnCatalog";
...
<section id="press-on" className="bg-white py-16 sm:py-24">
  <MaxWidthWrapper className="space-y-16">
    <div className="text-center">
      <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight">
        Nuestras <span className="text-pink-500">Uñas Press-On</span>
      </h2>
      <p className="mt-4 text-gray-600 max-w-prose mx-auto">
        Diseños personalizados listos para usar
      </p>
    </div>
    <PressOnCatalog />
  </MaxWidthWrapper>
